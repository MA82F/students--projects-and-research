#!/usr/bin/env python3
"""
RDN (Residual Dense Network) Inference Script
...
def main():
    parser = argparse.ArgumentParser(description='RDN Super-Resolution Inference')
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            print(f"Running RDN inference with scale {args.scale}x...")
            ...
            result_file = os.path.join(args.temp_results, 'rdn_results.json')
